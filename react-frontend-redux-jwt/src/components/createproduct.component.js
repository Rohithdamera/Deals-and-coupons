...
const description = (value) => {
    if (value.length < 3 || value.length > 46) {
        return (
            <div className="alert alert-danger" role="alert">
...
const couponBrand = (value) => {
    ...
    class AddProd extends Component {
        constructor(props) {
            ...
            this.onChangecouponPrice = this.onChangecouponPrice.bind(this);
        ...
        render() {
            ...
            <ul>
              <li><a href="admin">Go Back<BiLogOutCircle/></a></li>
                        ...
                        <h1><center>Add Coupon </center></h1>
                        ...
                        >
                            {!this.state.successful && (
                                <div>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="couponBrand">Coupon Brand</label>
                                        <Input
                                            type="text"
                                            className="form-control"
                                            name="couponBrand"
