                            ...
                            <tbody>
                                {
                                    this.state.coupons.map(
                                        ...
                                        <tr key = {coupon.couponId}>
                                            ...
                                            {/* <td> <li><a href="/StripeContainer">Buy</a></li></td> */}
  <td> <Link className="btn btn-outline-primary mx-2" to={"/Gpay"}> Buy </Link></td>
                                            
                                            
                                            {/* <IconButton color="primary" aria-label="buying.html">
                                                <buying.html />
                                            </IconButton> */}
                                             {/* <td>
