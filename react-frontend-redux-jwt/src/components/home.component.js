        ...
        <header class="header" >
          <nav>
            ...
            <ul>
              ...
              <li><a href="landing">LogOut<BiLogOutCircle/></a></li> 
            </ul>
          </nav>

          <div class="intro">
            <h1>WELCOME TO COUPON COUNTRY</h1>
            <h2>BUY COUPONS BEFORE<br /><span class="dis">THIS 31st NOV</span><br />AT 10%<br />EXTRA DISCOUNT</h2>
            <h3>Only available at CouponCountry</h3>
            <a href="Amazon" class="btn1">BUY NOW</a>
          </div>
